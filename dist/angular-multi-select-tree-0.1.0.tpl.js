angular.module('multi-select-tree').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('src/multi-select-tree.tpl.html',
    ...
    "    </span>\n" +
    "    <span ng-if=\"selectedItems.length > 0\" class=\"selected-items\">\n" +
    "      <span ng-repeat=\"selectedItem in selectedItems\" class=\"selected-item\" ng-bind=\"selectedItem[showField]\"><span class=\"selected-item-close\"\n" +
    ...
    "                       on-active-item=\"onActiveItem(item)\" select-only-leafs=\"selectOnlyLeafs\" show-field='title'></tree-item>\n" +
    "        </ul>\n" +
    "    </div>\n" +
    "</div>\n"
  );
  ...
  $templateCache.put('src/tree-item.tpl.html',
    ...
    "                                         ng-checked=\"item.selected\" /><span ng-bind=\"item[showField]\"></span>\n" +
    "        </div>\n" +
    "    </div>\n" +
    ...
    "                   on-active-item=\"activeSubItem(item, $event)\" show-field='title'></tree-item>\n" +
    "    </ul>\n" +
    "</li>\n"
  );
